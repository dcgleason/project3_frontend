...
function Search(props) {
  ...
  } else isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_3___default()('https://project3-restaurant-finder.herokuapp.com/restaurants').then(response => response.json()).then(data => {
    console.log(data);
  }).catch(err => {
    console.error({
      err
...
//# sourceMappingURL=Search.js.186039cc590f3a44ecd3.hot-update.js.map