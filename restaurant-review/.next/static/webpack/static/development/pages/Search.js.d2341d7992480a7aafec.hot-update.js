...
function Search(props) {
  // console.log(props)
  fetch('https://project3-restaurant-finder.herokuapp.com/restaurants').then(response => response.json()).then(data => {
    console.log(data);
  }).catch(err => {
    console.error({
      err
...
//# sourceMappingURL=Search.js.d2341d7992480a7aafec.hot-update.js.map